...
theme.Slideshow = (function() {
  ...
  Slideshow.prototype = Object.assign({}, Slideshow.prototype, {
    ...
    _setupActiveSlide: function(index) {
      ...
      (typeof variant_images!='object') && this.slides[index].setAttribute('aria-hidden', false);
      try{this.slides[index].setAttribute('aria-hidden', false);
      this.slides[index].classList.add(this.options.slideActiveClass);}catch(e){}
    },
  ...
  Product.prototype = Object.assign({}, Product.prototype, {
    ...
    _setActiveThumbnail: function(mediaId) {
      ...
      if (activeThumbnail) {
        ...
        (typeof via_product_handle != 'string') && this._adjustThumbnailSlider(activeThumbnail);
      }
    },
